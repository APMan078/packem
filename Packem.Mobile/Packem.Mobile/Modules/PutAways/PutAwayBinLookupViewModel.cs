...
namespace Packem.Mobile.Modules.PutAways
{
    ...
    public class PutAwayBinLookupViewModel : BaseViewModel
    {
        #region "Variables"
        ...
        public static event Action<BinItemQuantityLotViewModel> SelectedItem
        {
        ...
        public PutAwayBinLookupViewModel(INavigationService navigationService,
