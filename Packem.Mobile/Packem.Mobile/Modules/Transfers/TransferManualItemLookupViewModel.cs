...
{
    public class TransferManualItemLookupViewModel : BaseViewModel
    {
        #region "Variables"
        ...
        private static readonly WeakEventManager<ItemViewModel> _selectedInventoryEventManager =
        ...
        private async Task GridTap(GridSelectionChangedEventArgs e)
        {
            try
            {
                ...
                {
                    _selectedInventoryEventManager.RaiseEvent(selectedItem, nameof(SelectedInventory));
        ...
        public static event Action<ItemViewModel> SelectedInventory
        {
        ...
        public TransferManualItemLookupViewModel(INavigationService navigationService,
