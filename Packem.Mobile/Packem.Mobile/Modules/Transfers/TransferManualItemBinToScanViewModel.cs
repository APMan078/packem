...
{
    public class TransferManualItemBinToScanViewModel : BarcodeScanBaseViewModel
    {
        #region "Variables"
        ...
        public TransferManualItemBinToScanViewModel(INavigationService navigationService,
