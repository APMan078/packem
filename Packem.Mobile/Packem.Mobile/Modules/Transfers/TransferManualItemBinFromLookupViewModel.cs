...
namespace Packem.Mobile.Modules.Transfers
{
    ...
    public class TransferManualItemBinFromLookupViewModel : BaseViewModel
    {
        #region "Variables"
        ...
        private static readonly WeakEventManager<BinItemQuantityViewModel> _selectedItemEventManager =
        ...
        public ObservableRangeCollection<BinItemQuantityViewModel> Bins { get; }
        ...
        private async Task Search(string searchText)
        {
            try
            {
                ...
                var result = await _binService
                    .GetBinLookupItemQuantityDevice(state.DeviceState, state.Facility.CustomerFacilityId, ItemId, ZoneId, searchText);
        ...
        private async Task GridTap(GridSelectionChangedEventArgs e)
        {
            try
            {
                ...
                var selectedItem = e.AddedItems[0] as BinItemQuantityViewModel;
        ...
        public static event Action<BinItemQuantityViewModel> SelectedBin
        {
        ...
        public TransferManualItemBinFromLookupViewModel(INavigationService navigationService,
            ...
            IUnauthorizedService unauthorizedService)
        {
            ...
            Bins = new ObservableRangeCollection<BinItemQuantityViewModel>();
        ...
        public override async Task InitializeAsync()
        {
            try
            {
                ...
                var state = JsonConvert.DeserializeObject<MobileState>(stateJson);
                var result = await _binService
                    .GetBinLookupItemQuantityDevice(state.DeviceState, state.Facility.CustomerFacilityId, ItemId, ZoneId, null);
