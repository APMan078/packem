...
namespace Packem.WebApi.Migrations
{
    ...
    [Migration("20220901155137_AddColumn_Palletized_To_LicensePlate_And_MixedPallet_To_Pallet")]
    partial class AddColumn_Palletized_To_LicensePlate_And_MixedPallet_To_Pallet
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Packem.Domain.Entities.ActivityLog", b =>
                {
                    ...
                    b.Property<int?>("MathematicalSymbol")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Packem.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Property<int?>("DefaultItemThreshold")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Packem.Domain.Entities.LicensePlate", b =>
                {
            ...
            modelBuilder.Entity("Packem.Domain.Entities.LicensePlateItem", b =>
                {
                    b.Property<int>("LicensePlateItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("LicensePlateItemId"));
                    ...
                    b.ToTable("LicensePlates_Items", (string)null);
                });

            modelBuilder.Entity("Packem.Domain.Entities.Lot", b =>
                {
                    b.Property<int>("LotId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Packem.Domain.Entities.OrderCustomer", b =>
                {
                    b.Property<int>("OrderCustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("OrderCustomerId"));
            ...
            modelBuilder.Entity("Packem.Domain.Entities.OrderCustomerAddress", b =>
                {
                    b.Property<int>("OrderCustomerAddressId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("OrderCustomerAddressId"));
                    ...
                    b.HasKey("OrderCustomerAddressId");

                    b.HasIndex("Deleted");

                    b.HasIndex("OrderCustomerId");

                    b.ToTable("OrderCustomerAddresses", (string)null);
                });
            ...
            modelBuilder.Entity("Packem.Domain.Entities.Pallet", b =>
                {
                    b.Property<int>("PalletId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("PalletId"));
            ...
            modelBuilder.Entity("Packem.Domain.Entities.PalletInventory", b =>
                {
                    b.Property<int>("PalletInventoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("PalletInventoryId"));
                    ...
                    b.HasIndex("LicensePlateItemId")
                        .IsUnique();

                    b.HasIndex("PalletId");

                    b.ToTable("Pallets_Inventories", (string)null);
                });
            ...
            modelBuilder.Entity("Packem.Domain.Entities.UserRoleVendor", b =>
                {
                    b.Property<int>("UserRoleVendorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("UserRoleVendorId"));
                    ...
                    b.ToTable("Users_Roles_Vendors", (string)null);
                });
            ...
            modelBuilder.Entity("Packem.Domain.Entities.InventoryBin", b =>
                {
                    ...
                    b.HasOne("Packem.Domain.Entities.Lot", "Lot")
                        .WithMany("InventoryBins")
                        .HasForeignKey("LotId")
            ...
            modelBuilder.Entity("Packem.Domain.Entities.LicensePlateItem", b =>
                {
                    ...
                    b.HasOne("Packem.Domain.Entities.LicensePlate", "LicensePlate")
                        .WithMany("LicensePlateItems")
            ...
            modelBuilder.Entity("Packem.Domain.Entities.OrderCustomerAddress", b =>
                {
                    b.HasOne("Packem.Domain.Entities.OrderCustomer", "OrderCustomer")
                        .WithMany("OrderCustomerAddresses")
            ...
            modelBuilder.Entity("Packem.Domain.Entities.Pallet", b =>
                {
                    ...
                    b.HasOne("Packem.Domain.Entities.LicensePlate", "LicensePlate")
                        .WithOne("Pallet")
                        .HasForeignKey("Packem.Domain.Entities.Pallet", "LicensePlateId")
                        .HasConstraintName("FK_Pallets_LicensePlates");
            ...
            modelBuilder.Entity("Packem.Domain.Entities.PalletInventory", b =>
                {
                    ...
                    b.HasOne("Packem.Domain.Entities.LicensePlateItem", "LicensePlateItem")
                        .WithOne("PalletInventory")
                        .HasForeignKey("Packem.Domain.Entities.PalletInventory", "LicensePlateItemId")
                        .HasConstraintName("FK_PalletsInventories_LicensePlatesItems");

                    b.HasOne("Packem.Domain.Entities.Pallet", "Pallet")
                        .WithMany("PalletInventories")
            ...
            modelBuilder.Entity("Packem.Domain.Entities.PutAway", b =>
                {
                    ...
                    b.HasOne("Packem.Domain.Entities.Pallet", "Pallet")
                        .WithOne("PutAway")
                        .HasForeignKey("Packem.Domain.Entities.PutAway", "PalletId")
                        .HasConstraintName("FK_PutAways_Pallets");
            ...
            modelBuilder.Entity("Packem.Domain.Entities.SaleOrder", b =>
                {
                    b.HasOne("Packem.Domain.Entities.OrderCustomerAddress", "BillingAddress")
                        .WithMany("SaleOrderBillingAddresses")
                    ...
                    b.HasOne("Packem.Domain.Entities.OrderCustomerAddress", "ShippingAddress")
                        .WithMany("SaleOrderShippingAddresses")
            ...
            modelBuilder.Entity("Packem.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Navigation("LicensePlateItems");
            ...
            modelBuilder.Entity("Packem.Domain.Entities.CustomerFacility", b =>
                {
                    b.Navigation("PalletInventories");
            ...
            modelBuilder.Entity("Packem.Domain.Entities.OrderCustomer", b =>
                {
                    b.Navigation("OrderCustomerAddresses");
            ...
            modelBuilder.Entity("Packem.Domain.Entities.OrderCustomerAddress", b =>
                {
                    b.Navigation("SaleOrderBillingAddresses");

                    b.Navigation("SaleOrderShippingAddresses");
                });
