...
namespace Packem.WebApi.Migrations
{
    ...
    [Migration("20220704111923_AddInventoryTable_AddInventoryLocationTable_AddInventoryBinTable_RemoveItemLocationTable_RemoveItemBinTable")]
    partial class AddInventoryTable_AddInventoryLocationTable_AddInventoryBinTable_RemoveItemLocationTable_RemoveItemBinTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Packem.Domain.Entities.InventoryLocation", b =>
                {
                    ...
                    b.ToTable("Inventories_Locations", (string)null);
                });
            ...
            modelBuilder.Entity("Packem.Domain.Entities.Inventory", b =>
                {
                    ...
                    b.HasOne("Packem.Domain.Entities.Item", "Item")
                        .WithOne("Inventory")
                        .HasForeignKey("Packem.Domain.Entities.Inventory", "InventoryId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Packem.Domain.Entities.InventoryLocation", b =>
                {
                    b.HasOne("Packem.Domain.Entities.CustomerLocation", "CustomerLocation")
                        ...
                        .HasForeignKey("CustomerLocationId")
                        .HasConstraintName("FK_InventoriesLocations_CustomerLocations");

                    b.HasOne("Packem.Domain.Entities.Inventory", "Inventory")
                        .WithMany("InventoryLocations")
                        .HasForeignKey("InventoryId")
                        .HasConstraintName("FK_InventoriesLocations_Inventories");

                    b.HasOne("Packem.Domain.Entities.Location", "Location")
                        .WithMany("InventoryLocations")
                        .HasForeignKey("LocationId")
                        .HasConstraintName("FK_InventoriesLocations_Locations");
