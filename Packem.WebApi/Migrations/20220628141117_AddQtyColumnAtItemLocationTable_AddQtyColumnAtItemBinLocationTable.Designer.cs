...
namespace Packem.WebApi.Migrations
{
    ...
    [Migration("20220628141117_AddQtyColumnAtItemLocationTable_AddQtyColumnAtItemBinLocationTable")]
    partial class AddQtyColumnAtItemLocationTable_AddQtyColumnAtItemBinLocationTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Packem.Domain.Entities.ItemBin", b =>
                {
                    b.Property<int>("ItemBinId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ItemBinId"));
                    ...
                    b.ToTable("ItemBins", (string)null);
                });

            modelBuilder.Entity("Packem.Domain.Entities.ItemLocation", b =>
                {
            ...
            modelBuilder.Entity("Packem.Domain.Entities.Item", b =>
                {
                    b.HasOne("Packem.Domain.Entities.CustomerFacility", "CustomerFacility")
                        ...
                        .HasConstraintName("FK_Items_CustomerFacilities");
            ...
            modelBuilder.Entity("Packem.Domain.Entities.ItemBin", b =>
                {
                    b.HasOne("Packem.Domain.Entities.Bin", "Bin")
                        .WithMany("ItemBins")
                        .HasForeignKey("BinId")
                        .HasConstraintName("FK_ItemBins_Bins");

                    b.HasOne("Packem.Domain.Entities.CustomerLocation", "CustomerLocation")
                        .WithMany("ItemBins")
                        .HasForeignKey("CustomerLocationId")
                        .HasConstraintName("FK_ItemBins_CustomerLocations");

                    b.HasOne("Packem.Domain.Entities.Item", "Item")
                        .WithMany("ItemBins")
                        .HasForeignKey("ItemId")
                        .HasConstraintName("FK_ItemBins_Items");
            ...
            modelBuilder.Entity("Packem.Domain.Entities.ItemLocation", b =>
                {
                    b.HasOne("Packem.Domain.Entities.CustomerLocation", "CustomerLocation")
                        ...
                        .HasForeignKey("CustomerLocationId")
                        .HasConstraintName("FK_ItemLocations_CustomerLocations");
                    ...
                    b.HasOne("Packem.Domain.Entities.Location", "Location")
                        .WithMany("ItemLocations")
                        .HasForeignKey("LocationId")
                        .HasConstraintName("FK_Receipts_Locations");
