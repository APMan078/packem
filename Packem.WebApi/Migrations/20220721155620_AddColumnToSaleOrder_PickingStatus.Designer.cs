...
namespace Packem.WebApi.Migrations
{
    ...
    [Migration("20220721155620_AddColumnToSaleOrder_PickingStatus")]
    partial class AddColumnToSaleOrder_PickingStatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Packem.Domain.Entities.Picking", b =>
                {
                    b.Property<int>("PickingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("PickingId"));
            ...
            modelBuilder.Entity("Packem.Domain.Entities.PickingBin", b =>
                {
                    b.Property<int>("PickingBinId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("PickingBinId"));
                    ...
                    b.ToTable("Pickings_Bins", (string)null);
                });
            ...
            modelBuilder.Entity("Packem.Domain.Entities.ReceiptBin", b =>
                {
                    b.Property<int>("ReceiptBinId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ReceiptBinId"));
                    ...
                    b.ToTable("Receipts_Bins", (string)null);
                });
            ...
            modelBuilder.Entity("Packem.Domain.Entities.Picking", b =>
                {
                    b.HasOne("Packem.Domain.Entities.CustomerLocation", "CustomerLocation")
                        .WithMany("Pickings")
                        .HasForeignKey("CustomerLocationId")
                        .HasConstraintName("FK_Pickings_CustomerLocations");

                    b.HasOne("Packem.Domain.Entities.OrderLine", "OrderLine")
                        .WithMany("Pickings")
                        .HasForeignKey("OrderLineId")
                        .HasConstraintName("FK_Pickings_OrderLines");
            ...
            modelBuilder.Entity("Packem.Domain.Entities.PickingBin", b =>
                {
                    b.HasOne("Packem.Domain.Entities.Bin", "Bin")
                        .WithMany("PickingBins")
                        .HasForeignKey("BinId")
                        .HasConstraintName("FK_PickingsBins_Bins");

                    b.HasOne("Packem.Domain.Entities.CustomerLocation", "CustomerLocation")
                        .WithMany("PickingBins")
                        .HasForeignKey("CustomerLocationId")
                        .HasConstraintName("FK_PickingsBins_CustomerLocations");

                    b.HasOne("Packem.Domain.Entities.Picking", "Picking")
                        .WithMany("PickingBins")
                        .HasForeignKey("PickingId")
                        .HasConstraintName("FK_PickingsBins_Pickings");
            ...
            modelBuilder.Entity("Packem.Domain.Entities.ReceiptBin", b =>
                {
                    b.HasOne("Packem.Domain.Entities.Bin", "Bin")
                        .WithMany("ReceiptBins")
                        .HasForeignKey("BinId")
                        .HasConstraintName("FK_ReceiptBins_Bins");

                    b.HasOne("Packem.Domain.Entities.CustomerLocation", "CustomerLocation")
                        .WithMany("ReceiptBins")
                        .HasForeignKey("CustomerLocationId")
                        .HasConstraintName("FK_ReceiptsBins_CustomerLocations");

                    b.HasOne("Packem.Domain.Entities.Receipt", "Receipt")
                        .WithMany("ReceiptBins")
                        .HasForeignKey("ReceiptId")
                        .HasConstraintName("FK_ReceiptBins_Receipts");
            ...
            modelBuilder.Entity("Packem.Domain.Entities.Bin", b =>
                {
                    ...
                    b.Navigation("PickingBins");

                    b.Navigation("PutAwayBins");

                    b.Navigation("ReceiptBins");
