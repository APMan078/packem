...
namespace Packem.WebApi.Migrations
{
    ...
    [Migration("20220803141215_AddTable_OrderCustomerAddress")]
    partial class AddTable_OrderCustomerAddress
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Packem.Domain.Entities.OrderCustomerBillingAddress", b =>
                {
                    b.Property<int>("OrderCustomerBillingAddressId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("OrderCustomerBillingAddressId"));
                    ...
                    b.HasKey("OrderCustomerBillingAddressId");

                    b.HasIndex("Deleted");

                    b.HasIndex("OrderCustomerId");

                    b.ToTable("OrderCustomerBillingAddresses", (string)null);
                });

            modelBuilder.Entity("Packem.Domain.Entities.OrderCustomerShippingAddress", b =>
                {
                    b.Property<int>("OrderCustomerShippingAddressId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("OrderCustomerShippingAddressId"));
                    ...
                    b.HasKey("OrderCustomerShippingAddressId");

                    b.HasIndex("Deleted");

                    b.HasIndex("OrderCustomerId");

                    b.ToTable("OrderCustomerShippingAddresses", (string)null);
                });
            ...
            modelBuilder.Entity("Packem.Domain.Entities.SaleOrder", b =>
                {
                    ...
                    b.HasIndex("OrderCustomerBillingAddressId");

                    b.HasIndex("OrderCustomerId");

                    b.HasIndex("OrderCustomerShippingAddressId");
            ...
            modelBuilder.Entity("Packem.Domain.Entities.OrderCustomerBillingAddress", b =>
                {
                    b.HasOne("Packem.Domain.Entities.OrderCustomer", "OrderCustomer")
                        .WithMany("OrderCustomerBillingAddresses")
                        .HasForeignKey("OrderCustomerId")
                        .HasConstraintName("FK_OrderCustomerBillingAddresses_OrderCustomers");
            ...
            modelBuilder.Entity("Packem.Domain.Entities.OrderCustomerShippingAddress", b =>
                {
                    b.HasOne("Packem.Domain.Entities.OrderCustomer", "OrderCustomer")
                        .WithMany("OrderCustomerShippingAddresses")
                        .HasForeignKey("OrderCustomerId")
                        .HasConstraintName("FK_OrderCustomerShippingAddresses_OrderCustomers");
            ...
            modelBuilder.Entity("Packem.Domain.Entities.SaleOrder", b =>
                {
                    ...
                    b.HasOne("Packem.Domain.Entities.OrderCustomerBillingAddress", "OrderCustomerBillingAddress")
                        .WithMany("SaleOrders")
                        .HasForeignKey("OrderCustomerBillingAddressId")
                        .HasConstraintName("FK_SaleOrders_OrderCustomerBillingAddresses");
                    ...
                    b.HasOne("Packem.Domain.Entities.OrderCustomerShippingAddress", "OrderCustomerShippingAddress")
                        .WithMany("SaleOrders")
                        .HasForeignKey("OrderCustomerShippingAddressId")
                        .HasConstraintName("FK_SaleOrders_OrderCustomerShippingAddresses");
                    ...
                    b.Navigation("OrderCustomerBillingAddress");

                    b.Navigation("OrderCustomerShippingAddress");
            ...
            modelBuilder.Entity("Packem.Domain.Entities.OrderCustomer", b =>
                {
                    ...
                    b.Navigation("OrderCustomerBillingAddresses");

                    b.Navigation("OrderCustomerShippingAddresses");
